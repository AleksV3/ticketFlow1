...
Project setup phase. See [docs/02-product-requirements-and-build-brief.md](docs/02-product-requirements-and-build-brief.md) for the full spec and build plan.

## Setup

_To be filled in once the backend scaffold exists (Docker Compose + Spring Boot + Flyway)._
