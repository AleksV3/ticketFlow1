...
- [ ] T008 Write `data-model.md` for subtype, field definition/option/value, routing, approval, type availability, and parent-ticket relationships, indexes, deletion rules, and audit targets.
- [ ] T009 [P] Write admin contracts for subtype, field, option, routing, activation, safe deletion, and organization type availability.
...
- [ ] T034 Extend create-ticket DTO/domain service with subtype ID, dynamic values, and optional parent ticket key.
- [ ] T035 Validate required/unknown/type/length/option/reference values against one server-loaded definition snapshot.
- [ ] T036 Resolve routing deterministically and atomically assign team/developer/approver; allow audited authorized overrides only.
...
- [ ] T052 Build subtype/field/option editor with ordering, activation, safe-delete feedback, and accessible controls.
- [ ] T053 Build routing editor for team/developer/fallback/approver configuration and validation feedback.
- [ ] T054 Extend organization workflow/type administration with internal types, active state, defaults, and unused-only deletion.
...
- [ ] T063 Run full backend/frontend suites and two-organization isolation suite.
