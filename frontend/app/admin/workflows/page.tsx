...
function WorkflowMap({ workflow, types, addState, addTransition, updateTransition, removeTransition, removeState, saveCanvasLayout }: {
  workflow: Workflow;
  types: TicketType[];
