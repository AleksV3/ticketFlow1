...
import { SearchableUserPicker } from "@/components/SearchableUserPicker";
...
function UserAdmin({current}:{current:CurrentUser}){
  ...
  const rolesForSelectedUser=selectedUser
    ? assignmentRoles.filter(role => role.party === (selectedUser.organizationId===null ? "TICKETFLOW1" : "CLIENT"))
    : [];
