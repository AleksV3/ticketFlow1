...
export function TicketCommunication({ ticketKey, internal = false }: { ticketKey: string; internal?: boolean }) {
  ...
  return <><div className="space-y-4">
    <section className="card w-full"><h2 className="text-lg font-bold">Comments</h2><form className="my-4 grid gap-3 sm:grid-cols-[1fr_150px_auto] sm:items-end" onSubmit={addComment}>
