...
export const permittedLinks=(permissions:string[],organizationName?:string|null)=>NAV_LINKS.filter(link=>permissions.includes(link.permission) && (link.href!=="/teams" || organizationName==="TicketFlow1 Internal"));
