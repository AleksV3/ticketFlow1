...
public class Notification {
    ...
    public Notification(AppUser recipient, Ticket ticket, AppUser actor, String eventType, String title, String message) {
        this.recipient = recipient; this.ticket = ticket; this.actor = actor; this.eventType = eventType; this.title = title; this.message = message;
    }
    public Long getId(){return id;} public AppUser getRecipient(){return recipient;} public Ticket getTicket(){return ticket;} public AppUser getActor(){return actor;}
