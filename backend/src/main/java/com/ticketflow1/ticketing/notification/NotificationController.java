...
public class NotificationController {
    ...
    @PatchMapping("/{id}/read") public void markRead(@PathVariable Long id,@AuthenticationPrincipal AuthPrincipal principal){service.markRead(id,principal.userId());}
    @PostMapping("/read-all") public void markAllRead(@AuthenticationPrincipal AuthPrincipal principal){service.markAllRead(principal.userId());}
}
